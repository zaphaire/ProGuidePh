        ...
        <tbody>
            ...
            <tr style="border-bottom:1px solid #e5e7eb">
                <td style="padding:0.75rem;font-size:1.5rem">
                    ...
                    <a href="{{ url($file->url) }}" target="_blank">🖼️</a>
                    @else
                    📄
                    @endif
                </td>
                <td style="padding:0.75rem">
                    <a href="{{ url($file->url) }}" target="_blank" style="color:#2563eb;text-decoration:none">{{ $file->original_name }}</a>
                </td>
                ...
                <td style="padding:0.75rem;text-align:right">
                    <button onclick="navigator.clipboard.writeText('{{ url($file->url) }}')" class="btn btn-ghost btn-sm">Copy URL</button>
